    ...
    <main className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form className="space-y-4">
          ...
          <button type="submit" className="w-full bg-[#D4AF36] text-white py-2 rounded-md font-semibold hover:bg-[#C09F27] transition-colors">Register</button>
        </form>
        <div className="mt-6 text-center text-sm text-gray-600">
          Already have an account? <Link href="/login" className="text-[#D4AF36] font-medium hover:underline">Login</Link>
        </div>
      </div>
    </main>
  );
