...
const categories = [
  { id: 'furniture', name: 'Furniture', count: 48 },
  { id: 'tableware', name: 'Tableware', count: 36 },
  { id: 'decor', name: 'Decor', count: 54 },
  { id: 'backdrops', name: 'Backdrops', count: 18 }
];

// Sub-categories
const subCategories: Record<string, Array<{ id: string, name: string, count: number }>> = {
  furniture: [
    { id: 'chairs', name: 'Chairs', count: 15 },
    { id: 'tables', name: 'Tables', count: 12 },
    { id: 'sofas', name: 'Sofas', count: 8 },
    { id: 'bars', name: 'Bars', count: 5 },
    { id: 'pedestals', name: 'Pedestals', count: 8 }
  ],
  tableware: [
  ...
  decor: [
    { id: 'candles', name: 'Candles', count: 15 },
    { id: 'centerpieces', name: 'Centerpieces', count: 12 },
    { id: 'signage', name: 'Signage', count: 8 },
    { id: 'props', name: 'Props', count: 19 }
  ],
  backdrops: [
    { id: 'fabric', name: 'Fabric', count: 6 },
    { id: 'flower-walls', name: 'Flower Walls', count: 5 },
    { id: 'geometric', name: 'Geometric', count: 4 },
